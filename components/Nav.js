...
export const navData = [
  ...
  { name: 'Experiências', path: '/work', icon: <HiViewColumns /> },
  {
    name: 'Feedbacks',
    path: '/testimonials',
  ...
  return (
    <nav className="flex flex-col items-center xl:justify-center gap-y-4
     fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
      ...
      xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] xl:h-max py-8 bg-white/10 background-blur-sm text-3xl xl:text-xl xl:rounded-full ">
            ...
            items-center group hover:text-accent transition-all duration-300`}>
              ...
              <div className='absolute pr-14 right-0 hidden xl:group-hover:flex rounded-[3px]'>
                <div className='bg-white relative flex text-primary items-center p-[6px]'>
                  ...
                  <div className='boder-solid border-l-white border-l-8 
